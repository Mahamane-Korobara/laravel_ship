...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'deploy.base_path' => 'string',
            'deploy.max_releases' => 'string',
            'deploy.admin_email' => 'string',
            ...
            'filesystems.links./home/mahamane/Bureau/Mahamane/Projet_laravel/laravel-ship/public/storage' => 'string',
            ...
            'github-webhooks.signing_secret' => 'NULL',
            'github-webhooks.jobs' => 'array',
...
'database.redis.cache.max_retries','database.redis.cache.backoff_algorithm','database.redis.cache.backoff_base','database.redis.cache.backoff_cap','deploy.base_path',
'deploy.max_releases','deploy.admin_email','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mahamane/Bureau/Mahamane/Projet_laravel/laravel-ship/public/storage',
...
'services.slack.notifications.channel','services.github.client_id','services.github.client_secret','services.github.redirect','session.driver',
...
'reverb.apps.apps.0.max_message_size','reverb.apps.apps.0.accept_client_events_from','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'livewire.pagination_theme','livewire.release_token','github-webhooks.signing_secret','github-webhooks.jobs','github-webhooks.model',
'github-webhooks.prune_webhook_calls_after_days','github-webhooks.job','github-webhooks.profile','github-webhooks.verify_signature','webhook-client.configs.0.name',
...
'webhooks.github','auth.github','auth.github.callback','register',
'login','password.request','password.reset','verification.notice','verification.verify',
'password.confirm','storage.local','storage.local.upload',);
...
'layouts.app','layouts.guest','livewire.deployments.deployment-logs','livewire.deployments.deployment-show','livewire.layout.navigation',
...
'livewire.pages.auth.verify-email','livewire.profile.delete-user-form','livewire.profile.update-password-form','livewire.profile.update-profile-information-form','livewire.projects.project-deploy',
'livewire.projects.project-import','livewire.projects.project-settings','livewire.projects.project-show','livewire.welcome.navigation','profile',
'volt-livewire::deployments.deployment-logs','volt-livewire::deployments.deployment-show','volt-livewire::layout.navigation','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password',
...
'volt-livewire::profile.update-password-form','volt-livewire::profile.update-profile-information-form','volt-livewire::projects.project-deploy','volt-livewire::projects.project-import','volt-livewire::projects.project-settings',
'volt-livewire::projects.project-show','volt-livewire::welcome.navigation','welcome','e60dd9d2c3a62d619c9acb38f20d5aa5::accent','e60dd9d2c3a62d619c9acb38f20d5aa5::aside',
...
'REDIS_HOST','REDIS_PASSWORD','REDIS_PORT','MAIL_MAILER','MAIL_FROM_ADDRESS',
'MAIL_FROM_NAME','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET','GITHUB_REDIRECT_URI','REVERB_APP_ID',
...
'DEPLOY_BASE_PATH','DEPLOY_MAX_RELEASES','ADMIN_EMAIL',);
