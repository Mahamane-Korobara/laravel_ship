...
<div
    ...
    class="relative"
    {{ $attributes->except(['wire:model','wire:model.live','wire:model.blur','wire:model.lazy','wire:model.defer']) }}>
    <button
        type="button"
        @click="open = !open"
        ...
        <svg class="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
            <path d="m6 9 6 6 6-6" />
        </svg>
    </button>
    ...
    <div
        ...
        <div class="max-h-56 overflow-y-auto ship-scroll py-1">
            ...
            <button
                ...
                <svg x-show="selected == @js($opt['value'])" viewBox="0 0 24 24" class="h-4 w-4 text-indigo-400" fill="none" stroke="currentColor" stroke-width="2">
