...
'default' => 'rounded-lg border border-slate-700 bg-transparent text-white hover:bg-slate-800 shadow-none',
'indigo' => 'rounded-lg bg-indigo-600 text-white hover:bg-indigo-500 shadow-lg shadow-indigo-900/40',
];
$sizes = [
